...
class IncomeSection extends ConsumerWidget {
  ...
  final double totalIncome; // このプロパティを追加

  const IncomeSection({
    super.key,
    required this.isExpanded,
    required this.onExpandToggle,
    required this.totalIncome, // このパラメータを追加
  });
            ...
            SizedBox(
              ...
              child: Stack(
                children: [
                  Center(
                    child: Text(
                      '${totalIncome.toStringAsFixed(0)} 円',
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const FullScreenIncomeSection()),
                        );
                      },
                    ),
                  ),
