...
class _MyPageState extends ConsumerState<MyPage> {
  ...
  Widget buildMedalCell(Medal medal) {
    ...
    switch (medal.type) {
      case MedalType.gold:
        medalWidget = Icon(Icons.workspace_premium, color: Colors.amber, size: 32,);
        // medalWidget = Image.asset("assets/images/gold.png", width: 32, height: 32);
        label = "金";
        break;
      case MedalType.silver:
        medalWidget = Icon(Icons.workspace_premium, color: Colors.grey, size: 32);
        // medalWidget = Image.asset("assets/images/silver.png", width: 32, height: 32);
        label = "銀";
        break;
      case MedalType.bronze:
        medalWidget = Icon(Icons.workspace_premium, color: Colors.brown, size: 32);
